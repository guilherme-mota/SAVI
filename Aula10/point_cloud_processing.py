...
class PointCloudProcessing():
    ...
    def loadPointCloud(self, file_name):

        print('Load a point cloud from ' + file_name)
    ...
    def crop(self, min_x, min_y, min_z, max_x, max_y, max_z):
        ...
        # First create a point cloud with the vertices of the desired bbox
        ...
        # Create Axis Aligned BoundingBox from points
