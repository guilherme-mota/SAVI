...
def main():
    ...
    tracker_type = tracker_types[2]  # KCF, MOSSE and CSRT
    ...
    video = cv2.VideoCapture("/home/guilherme/savi_22-23/Parte03/docs/people_walking_small_noaudio.mp4")
    ...
    output = cv2.VideoWriter(f'{tracker_type}.avi', cv2.VideoWriter_fourcc(*'XVID'), 60.0, 
